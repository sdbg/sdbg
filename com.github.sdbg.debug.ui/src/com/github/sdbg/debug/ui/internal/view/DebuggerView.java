...
public class DebuggerView extends LaunchView implements ILaunchesListener {
  public static final String ID = "com.github.sdbg.debug.ui.debuggerView"; //$NON-NLS-1$
  ...
  public void createPartControl(Composite parent) {
    ...
    if (CONNECTED_IMAGE == null) {
      ...
      CONNECTED_IMAGE = SDBGDebugUIPlugin.getImage(new DecorationOverlayIcon(
          NOT_CONNECTED_IMAGE,
          SDBGDebugUIPlugin.getImageDescriptor("ovr16/play.png"),
