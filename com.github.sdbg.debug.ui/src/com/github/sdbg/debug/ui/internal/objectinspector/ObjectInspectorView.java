...
import com.github.sdbg.debug.ui.internal.objectinspector.ExpressionEvaluateJob.ExpressionListener;
...
public class ObjectInspectorView extends ViewPart implements IDebugEventSetListener,
  ...
  public static final String ID = "com.github.sdbg.debug.ui.objectInspectorView"; //$NON-NLS-1$
    ...
    try {
      ...
      if (newInspector) {
        ...
        if (page.getActivePart() instanceof ObjectInspectorView) {
          ...
          view = (ObjectInspectorView) page.showView(ID);
        }
      }
