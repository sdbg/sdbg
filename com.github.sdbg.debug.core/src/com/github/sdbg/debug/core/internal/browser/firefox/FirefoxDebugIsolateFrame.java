...
/**
 * A pseudo stack frame for the current isolate. This frame will be able to
 * enumerate all the libraries in the current isolate, and each library's
 * top-level variables.
 */
public class FirefoxDebugIsolateFrame extends BrowserDebugElement<FirefoxDebugTarget> implements IStackFrame
{
