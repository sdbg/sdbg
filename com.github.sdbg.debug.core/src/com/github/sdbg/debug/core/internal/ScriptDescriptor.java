...
public class ScriptDescriptor
{
    ...
    public ScriptDescriptor(String scriptId, String url, String sourceMapURL, boolean isContentScript, int startLine,
    ...
    {
        // For things like
        // data:application/dart;base64,CiAgICAgICAgaW1wb...3J0ICd==
    ...
    public boolean isSystemScript()
    {
        ...
        // TODO(devoncarew): this hack has to do with how Dartium is built, and
    ...
    {
        // TODO(devoncarew): this method converts unqualified library urls to
        // slightly better formed urls.
        if (url != null)
        {
