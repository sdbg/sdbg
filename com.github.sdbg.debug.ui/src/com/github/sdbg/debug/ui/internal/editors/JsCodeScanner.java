...
public class JsCodeScanner extends BufferedRuleBasedScanner {
  ...
  private final TextAttribute commentAttribute = new TextAttribute(EditorColors.getColor(new RGB(
      63,
      127,
      95)), null, SWT.NORMAL);

  private final TextAttribute jsDocAttribute = new TextAttribute(EditorColors.getColor(new RGB(
      127,
      127,
      159)), null, SWT.NORMAL);
  ...
  private void createRules() {
    Token keywordToken = new Token(new TextAttribute(
        EditorColors.getColor(new RGB(127, 0, 85)),
        null,
        SWT.BOLD));
    ...
    Token stringToken = new Token(new TextAttribute(
        EditorColors.getColor(new RGB(42, 0, 255)),
        null,
        SWT.NORMAL));
    ...
    Token numberToken = new Token(new TextAttribute(
        EditorColors.getColor(blackRgb),
        null,
        SWT.NORMAL));
